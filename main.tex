...
\begin{tikzpicture}[%
  ...
  \begin{scope}[xshift=2.2cm, yshift=-0.1cm]
    ...
    % Text‑Labels – hier den Kreisstil abschalten:
    \node[anchor=west,shape=rectangle,draw=none] at (0.8,  0)   {normal};
    \node[anchor=west,shape=rectangle,draw=none] at (0.8,-0.7) {potential outlier};
    \node[anchor=west,shape=rectangle,draw=none] at (0.8,-1.4) {outlier};
  \end{scope}
