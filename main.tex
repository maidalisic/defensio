...
% ---------------- Short-cuts / Symbols ------------------------- %
\newcommand{\tfidf}{TF-IDF\xspace}   % nach Erst-Erwähnung erlaubt
...
% --------------------------------------------------------------- %
\section{Method - Algorithm \circledtwo}
...
% --------------------------------------------------------------- %
\section{Method - Algorithm \circledthree}
% \section{Method - Algorithm }
...
\vspace{0.35em}
{\scriptsize 30 µs per line in IF • overall 37 ms @ p99.9}
\end{frame}
